...
raw.shading.material = raw.define(function (proto, _super) {
  ...
  material.shader = raw.webgl.shader.parse(import('shaders/flat_material.glsl'));
...
raw.shading.shaded_material = raw.define(function (proto, _super) {
  ...
  shaded_material.shader = raw.webgl.shader.parse(import('shaders/shaded_material.glsl'));
